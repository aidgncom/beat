...
The setup is straightforward, and you can easily follow along with the video on the Aidgn YouTube channel: [https://youtu.be/A4BSwKlKQJY](https://youtu.be/A4BSwKlKQJY)
...
While real-time analytics and security layers based on event sequences can be implemented directly on the client side, deploying to Edge maximizes Full Score's potential with options like WAF blocking, personalization, AI analysis, and archiving to GitHub or another storage. **Resonator** is the official reference implementation for interpreting BEAT and is licensed under the AGPL-3.0-or-later.
...
```
<script src="https://cdn.jsdelivr.net/gh/aidgncom/beat@main/reference/fullscore/fullscore.basic.min.js"></script>
// Basic (2.69KB gzip): BEAT + RHYTHM

<script src="https://cdn.jsdelivr.net/gh/aidgncom/beat@main/reference/fullscore/fullscore.standard.min.js"></script>
// Standard (3.13KB gzip): TEMPO + BEAT + RHYTHM

<script src="https://cdn.jsdelivr.net/gh/aidgncom/beat@main/reference/fullscore/fullscore.extended.min.js"></script>
...
Deploying to Edge maximizes Full Score's potential with no API endpoints required. Resonator is the official BEAT interpreter. The setup is straightforward, and you can easily follow along with the video on the Aidgn YouTube channel: [https://youtu.be/A4BSwKlKQJY](https://youtu.be/A4BSwKlKQJY)
